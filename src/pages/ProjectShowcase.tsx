...
const ProjectShowcase = () => {
  return (
    <section className="min-h-screen bg-black text-white px-6 py-24 md:px-12 lg:px-16">
      <div className="mx-auto max-w-[1600px]">
        <div className="mb-16 flex items-end justify-between gap-8 border-b border-white/20 pb-6">
          ...
          <span className="hidden text-xs font-bold uppercase tracking-widest text-white/50 md:block">
              ...
              <div className="p-6 md:p-8">
                <div className="mb-8 flex items-start justify-between gap-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="mt-2 text-xs font-bold uppercase tracking-[0.18em] text-white/50">
                        {project.stack}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <a
                    ...
                    className="border border-white px-4 py-3 text-xs font-black uppercase tracking-widest transition hover:bg-white hover:text-black"
                  >
                    Source ↗
                  </a>
                  {project.links.live && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="px-4 py-3 text-xs font-black uppercase tracking-widest text-white/60 transition hover:text-white"
                    >
                      Live Demo ↗
                    </a>
                  )}
